...
const entradaUsuario = (usuarios, usuarioEnJuego) => {
    ...
    do {
        ...
        if (indiceUsuario >= 0) {
            do {
                reNombre = prompt("EL usuario \"" + usuarioVacio.nombre + "\" ya existe.\n" +
...
const presentaPanelTurno = (bolaEnJuego, acierto, cartonEnJuego, usuarioEnJuego) => {
    ...
    respuesta = prompt ("--------Tu cartón--------      < Puntos: " + usuarioEnJuego.puntos + ">   " +
                            estadoUsuario + "\n" +
...
const bingo = () => {
    ...
    do {
        ...
        } while (respuesta !== null && !aciertoEnTurno.bingo)
